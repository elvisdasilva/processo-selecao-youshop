...
class PlantedTree(models.Model):
    ...
    location_latitude = models.DecimalField(max_digits=10, decimal_places=6, null=False, blank=False)
    location_longitude = models.DecimalField(max_digits=10, decimal_places=6, null=False, blank=False)
